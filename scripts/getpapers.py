...
Urls = ["https://www.sciencedirect.com/journal/journal-of-asian-earth-sciences/vol/10000/suppl/C","https://www.sciencedirect.com/journal/geoscience-frontiers/vol/1000/issue/20","https://www.sciencedirect.com/journal/lithos/vol/10000/suppl/C","https://www.sciencedirect.com/journal/geochimica-et-cosmochimica-acta/vol/10000/suppl/C","https://www.sciencedirect.com/journal/chemical-geology/vol/10000/suppl/C","https://www.sciencedirect.com/journal/earth-and-planetary-science-letters/vol/10000/suppl/C","https://www.sciencedirect.com/journal/earth-science-reviews/vol/10000/suppl/C"]  #
...
Chemical_Geology = "https://www.sciencedirect.com/journal/chemical-geology/vol/"
EPSL = "https://www.sciencedirect.com/journal/earth-and-planetary-science-letters/vol/"
ESR = "https://www.sciencedirect.com/journal/earth-science-reviews/vol/"
GCA = "https://www.sciencedirect.com/journal/geochimica-et-cosmochimica-acta/vol/"
pages = 0
pages_is = 0
issue = ""
#Urls = ["",""]
hosts = [Chemical_Geology, EPSL, ESR, GCA]
for host in hosts:
    if Chemical_Geology:
        pages = 269
        pages_is = 654
        while pages <= pages_is:
            issue = host + str(pages)
            Urls.append(issue)
            pages = pages + 1
            #print(issue)
    elif EPSL:
